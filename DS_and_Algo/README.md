...
* If you wanted to give `true` or `false` for [this](https://www.geeksforgeeks.org/find-k-numbers-which-are-powers-of-2-and-have-sum-n/), then here is a very easy approach:
...
public class ExpressingSum {
    public static void main(String[] args) {
        ...
        System.out.println("correct = " + correct); // correct is true
    }
